...
def _build_llm_prompt(raw_text: str, image_url: str | None = None) -> str:
    prompt = (
        ...
        "INSTRUÇÃO DE RECONHECIMENTO VISUAL (CRÍTICO): "
        "Os nomes dos heróis NÃO estão escritos em texto. Você deve olhar para o ÍCONE ou o MODELO 3D do herói em cada coluna. "
        "Identifique o herói por sua aparência visual. Se vir um personagem de gelo, pode ser Crystal Maiden ou Lich; se vir um macaco, é Monkey King. "
        "Sob nenhuma circunstância retorne \"null\" para hero_name. Se tiver dúvida, coloque o nome do herói que mais se assemelha visualmente. "
        "Mapeie a coluna do jogador diretamente com o herói que aparece nela. "
        "Ordem das colunas: lembre que o Dota tem 5 jogadores na esquerda (Radiant) e 5 na direita (Dire). "
        "Isso ajuda a não se perder nas linhas.\n\n"
